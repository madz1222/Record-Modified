...
<div class="col-lg-12">
  ...
  <input type="text" name="other_course" class="form-control" placeholder="Enter your course" value="<?php echo isset($_POST['other_course']) ? $_POST['other_course'] : '' ?>">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label>To:</label>
							<input type="text" name="year_graduate" class="form-control" placeholder="Enter Year" pattern="[0-9]{4}" title="Please enter a 4-digit number" value="<?php if(isset($_POST['upload'])) { echo $year_end; } ?>" required="">
						</div>
						<div class="form-group">
							<label>Status</label>
...
<script>
	...
	document.querySelector('select[name="course_name"]').addEventListener('change', function() {
    var selectedOption = this.value;
    var otherCourseInput = document.getElementById('other_course_input');
    var courseNameInput = document.querySelector('input[name="other_course"]');
