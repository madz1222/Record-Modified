				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Admin2</option>
						...
						<div class="form-group">
							...
							<div>
								<input type="password" class="form-control form-control-sm" name="password" id="passwordInput">
								<button1 type="button" onclick="togglePasswordVisibility('passwordInput', 'passwordEyeButton')"><b style='color:gray' ><i class="fas fa-eye"> Show </i></b></button>
							</div>
							<small><i><?php echo isset($id) ? "Leave this blank if you don't want to change the user's password":'' ?></i></small>
						</div>
						<div class="form-group">
							<label class="label control-label">Confirm Password</label>
							<div>
								<input type="password" class="form-control form-control-sm" name="cpass" id="confirmPasswordInput" >
								<button1 type="button" onclick="togglePasswordVisibility('confirmPasswordInput', 'confirmPasswordEyeButton')"><b style='color:gray' ><i class="fas fa-eye"> Show </i></b></button>
							</div>
